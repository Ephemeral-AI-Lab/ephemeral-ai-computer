...
| [20. Ephemeral AI FS replacement](./20_ephemeral_ai_fs.md) | How Ephemeral AI FS becomes the default while DOFS remains an optional comparison engine. |
| [21. Ephemeral AI FS swap](./21_ephemeral_ai_fs_swap.md) | Computer-side swap and benchmark checklist after the filesystem packages are ready. |
